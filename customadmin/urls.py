...
from .views import admin_login,admin_dashboard,view_all_adoption_request,approve_adoption_request,logout_admin,view_adoption_request,view_all_users,admin_view_userprofile,delete_userprofile
